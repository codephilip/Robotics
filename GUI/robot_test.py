...
def execute_commands():
    ...
    for index in range(len(command_list)):
        ...
        elif command_list[index]["command"] == "Reset":
            robot.reset_servos()
        elif command_list[index]["command"] == "Shoulder":
            robot.attack()
...
speed_options = [1, 2, 3]
time_options = [.5, 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 5]
...
button = Button(root, text="Add Command", command=add,
                width=32, height=1).pack()
delete_button = Button(root, text="Delete Command",
                       command=delete, width=32, height=1).pack()
reset_button = Button(root, text="Reset Commands",
                      command=reset_commands, width=32, height=1).pack()
execute_label = Label(root, text=" ").pack()
execute_button = Button(root, text="Execute Commands",
                        command=execute_commands, width=32, height=2).pack()
