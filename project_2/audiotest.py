...
class VoiceController:
    ...
    def voice_commands(self):
        print(self.voice)
        if "forward" in self.voice:
            print("Forward")
            #self.robot.motor_forward()
            self.voice = "0"
        elif "backward" in self.voice:
            print("Backward")
            #self.robot.motor_reverse()
            self.voice = "0"
        elif "left" in self.voice:
            print("Left")
            #self.robot.turn_left()
            self.voice = "0"
        elif "right" in self.voice:
            print("Right")
            #self.robot.turn_right()
            self.voice = "0"
        elif "look left" in self.voice:
            print("Look Left")
            #self.robot.turn_head_left()
            self.voice = "0"
        elif "look right" in self.voice:
            print("Look Right")
            #self.robot.turn_head_right()
            self.voice = "0"
        elif "look center" in self.voice:
            print("Look Center")
            #self.robot.turn_head_center()
            self.voice = "0"
        elif "look up" in self.voice:
            print("Look Up")
            #self.robot.tilt_head_up()
            self.voice = "0"
        elif "look down" in self.voice:
            print("Look Down")
            #self.robot.tilt_head_down()
            self.voice = "0"
        elif "turn left" in self.voice:
            print("Turn Left")
            #self.robot.turn_waist_left()
            self.voice = "0"
        elif "turn right" in self.voice:
            print("Turn Right")
            #self.robot.turn_waist_right()
            self.voice = "0"
        elif "turn center" in self.voice:
            print("Turn Center")
            #self.turn_waist_center()
            self.voice = "0"
        elif "stop" in self.voice:
            print("Stop")
            #self.robot.stop()
            self.voice = "0"
        elif "exit" in self.voice:
            print("Stop")
            #self.robot.stop()
            sys.exit()
            self.voice = "0"
